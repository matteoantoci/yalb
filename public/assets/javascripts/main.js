(function(d, w){
    ...
    document.addEventListener("touchstart", function(){}, true); //fastclick

    /* Fix for boostrap 3 drop down menu */
    var collapseMenu = function(){$(".navbar-collapse").removeClass("in").addClass("collapse");};
    $(".dropdown-menu li a").on('click', collapseMenu);
    $(document).on('click', collapseMenu);
    /*************************************/
